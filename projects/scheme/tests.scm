...
(define nope-1 (lambda))
; expect Error: too few operands

(define nope-2 (/ (lambda (x) (x) 4)))
; expect Error
...
(define blaze (lambda (b c) (+ b (* c 117))))
; expect blaze

(blaze 69 3)
; expect 420

(cond (True 0) (False 134141))
; expect 0
...
(define (enumerate s)
  ...
  (define (help s)
    (cond
          ((null? s) nil)
          (else (cons (cons (- len (length s)) (cons (car s) nil)) (help (cdr s))))))
    (help s))
; expect enumerate

(enumerate '(4 1 4 4 2 7))
; expect ((0 4) (1 1) (2 4) (3 4) (4 2) (5 7))

(enumerate '(False 5 2 1 True))
; expect ((0 False) (1 5) (2 2) (3 1) (4 True))
...
(list-change 10 '(24 4 2))
; expect ((4 4 2 2) (4 2 2 2 2 2 2) (2 2 2 2 2 2 2 2 2 2))
...
; expect let-to-lambda

(let-to-lambda '(let ((a 1)) (let ((b a)) ((let ((a b))  a)))))
; expect ((lambda (a) ((lambda (b) (((lambda (a) a) b))) a)) 1)
