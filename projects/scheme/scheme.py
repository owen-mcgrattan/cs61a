...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target):
        ...
        # BEGIN PROBLEM 10
        pair_expr=Pair(target.second,expressions.second)
        env.define(target.first,do_lambda_form(pair_expr,env))
        return target.first
        # END PROBLEM 10
    else:
